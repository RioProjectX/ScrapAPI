...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "scrapriobot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "scrapriobot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/scrapriobot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/scrapriobot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "Managed With ☕️ By @fckualot")
